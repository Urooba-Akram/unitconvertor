...
#Build a Google Unit Convertor using Python and Streamlit:#Project 01: Unit Convertor
...
st.markdown(
    ...
    .stButton > button {
        background: linear-gradient(45deg, #0b5394, rgb(77, 23, 52));
        color: black;
        font-size: 18px;
        padding: 10px 20px;
        border-radius: 10px;
...
def length_convertor(value, from_unit, to_unit):
    length_units = {
        ...
        'Yards': 1.09361, 'Feet': 3.28, 'Inches': 39.37
    }
...
st.markdown("<div class='footer'>Created with love by Urooba Akram</div>", unsafe_allow_html=True)